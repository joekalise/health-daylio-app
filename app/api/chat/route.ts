...
const TOOLS: Anthropic.Tool[] = [
  ...
  {
    name: "query_health",
    description: "Query health metrics. Types: steps, hrv, resting_hr, active_energy, sleep_total, workout, walking_distance, vo2max, weight, spo2, symptoms. symptoms is a manually logged 0–10 daily AS symptom severity scale.",
    input_schema: {
      type: "object" as const,
      properties: {
